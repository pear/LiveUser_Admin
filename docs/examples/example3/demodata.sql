...
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (1, 4, 'de', 'Lesen', 'Der Benutzer darf etwas lesen.');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (2, 4, 'de', 'Schreiben', 'Der Benutzer darf etwas schreiben.');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (3, 4, 'de', 'Zugangang', '"Sesam ?ffne dich"-Recht');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (4, 4, 'de', 'Feuer', 'Atombombe z?nden');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (5, 4, 'de', 'Lift up', 'Alien Raumschiff fliegen');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (6, 4, 'de', 'Kaffee machen', 'Kaffeepulver, Wasser, einschalten, warten ...');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (7, 4, 'de', 'Kaffee trinken', 'Ahh, Koffein');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (1, 4, 'en', 'Read', 'Read authority');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (2, 4, 'en', 'Write', 'Write something new');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (3, 4, 'en', 'Access', 'Open the doors');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (4, 4, 'en', 'Fire', 'Launch the atomic bombs');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (5, 4, 'en', 'Lift up', 'Let\'s fly an alian space craft');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (6, 4, 'en', 'Make coffee', 'coffee, water, switch it on, wait ...');
INSERT INTO liveuser_translations (section_id, section_type, language_id, name, description) VALUES (7, 4, 'en', 'Drink coffee', 'Ahh, caffeine');